...
"""
remove write_to_bmp function TM and make adjustment to rgb & f.write
...
# write to bmp TM
if __name__ == "__main__":
    jpeg_filename = "profile.jpg"
    bmp_filename = "profile.bmp"
